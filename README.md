...
This tells us that the pipeline is running. The `clone-repo` pipeline task has completely successfully and the `source-to-image` pipeline task is currently running.
